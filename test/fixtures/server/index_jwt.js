...
const {start} = require("../../../index.js").Bootstrap;
...
const {CatroEixosSwaggerMiddlewareJWT} = require("../../../index.js");

const JWT = CatroEixosSwaggerMiddlewareJWT({

    procesoGenerar: "JWT.firmar",
    procesoValidar: "JWT.validar",
    secreto: "836ceed1a8aa8470e6c561d67919e3f9",
...
start(swaggerDoc, opciones, (catroEixosMiddleware) => {
        ...
        swaggerTools.initializeMiddleware(swaggerDoc, function (middleware) {
            ...
            app.use(middleware.swaggerSecurity({
                ...
                ApiKeyHeader: function(req, securityDefinitions, scopes,callback){

                    JWT(req, securityDefinitions, scopes, callback);
